...
- **File**: `server/tests/globalSetup.ts`
  ...
  - Added `DATABASE_URL=postgresql://avail_user:ni_vineet_21@pg.avail.naxatar.com:5432/avail_explorer_test`
...
- **Test**: `postgresql://avail_user:ni_vineet_21@pg.avail.naxatar.com:5432/avail_explorer_test`
- **QA**: `postgresql://avail_user:ni_vineet_21@pg.avail.naxatar.com:5432/avail_explorer_qa`
- **Production**: `postgresql://avail_user:ni_vineet_21@pg.avail.naxatar.com:5432/avail_explorer`
...
psql postgresql://avail_user:ni_vineet_21@pg.avail.naxatar.com:5432/avail_explorer_test -c "SELECT version();"
``` 